...
namespace Daniell.Editor.Systems.DialogueNodes
{
    ...
    public abstract class BaseNode : Node
    {
        ...
        /// <summary>
        /// Default Icon for the node in the editor
        /// </summary>
        protected virtual string DefaultEditorIcon => "d_Record Off@2x";
        ...
        protected virtual void SetDefaultNodeStyleAndPosition()
        {
            ...
            var nodeIcon = new Image() { image = EditorGUIUtility.IconContent(DefaultEditorIcon).image };
            nodeIcon.style.width = 25;
            nodeIcon.style.height = 25;
            nodeIcon.style.position = Position.Absolute;
            nodeIcon.style.top = 6f;
